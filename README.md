...
# Elastic Export Shopping24.de Plugin for plentymarkets 7

This is the elastic export Shopping24.de plugin for plentymarkets 7 which extends the list of possible export formats. 
