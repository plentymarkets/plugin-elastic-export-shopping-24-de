...
By installing this plugin you will receive the export format **Shopping24DE-Plugin**. Use this format to exchange data between plentymarkets and Shopping24.de. It is required to install the Plugin Elastic export from the plentyMarketplace first before you can use the format **Shopping24DE-Plugin** in plentymarkets.

Once both plugins are installed, you can create the export format **Shopping24DE-Plugin**. Refer to the [Elastic Export](https://knowledge.plentymarkets.com/en/basics/data-exchange/elastic-export) page of the manual for further details about the individual format settings.
...
| **Format**                                            | Select **Shopping24DE-Plugin**. |
...
| **File name**                                         | The file name must have the ending **.csv** or **.txt** for Shopping24.de to be able to import the file successfully. |
| **Item filters**                                      | |
...
Go to **Data » Elastic export** and open the data format **Shopping24DE-Plugin** in order to download the export file. 

| **Column**       | **Explanation** | 
| :---             | :--- |
| art_name         | According to the format setting **item name**. |
| long_description | According to the format setting **Description**. |
| image_url        | The image URL. Variation images are prioritizied over item images. |
| deep_link        | The **URL path** of the item depending on the chosen **client** in the format. settings. |
| price            | The **sales price** of the variation. |
| old_price        | If the **RRP** is activated in the format setting and is higher than the **sales price**, the **RRP** will be exported. |
...
| art_number       | The **variation number** of the variation. |
| color            | The value of an attribute with an attribute link for **Amazon** to **Color**. |
| clothing_size    | The value of an attribute with an attribute link for **Amazon** to **Size**. |
| cut              | Empty. |
| link             | Empty. |
| unit_price       | The **base price information**. The format is "price / unit". Example: 10,00 EUR / kilogram. |
